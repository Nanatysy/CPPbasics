...
ScavTrap::~ScavTrap() {
	std::cout << "ScavTrap: " << this->getName() << " is dead, back to the "
													"level 1" << std::endl;
	return ;
}
...
void ScavTrap::attack(std::string const & target) {
	...
	{
		std::cout << "ScavTrap: " << this->getName() << "needs a little bit "
														"of time to rest before he/she can attack ";
...
void ScavTrap::guardGate(void) {
	if (!_home)
	{
		std::cout << "ScavTrap: " << this->getName() << " have entered in "
